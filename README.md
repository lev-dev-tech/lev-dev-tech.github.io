...
### Технический специалист · Python · Telegram-боты · Mini Apps · Веб · Серверы · Автоматизация
...
- ⚡ Глитч-анимация и typewriter-цикл ролей в заголовке
- 🏷️ Фильтрация проектов по категориям
- 🖥️ Живые превью проектов (iframe-мокапы браузера и телефона)
- ⭐ Слайдер отзывов с Kwork (10 отзывов)
